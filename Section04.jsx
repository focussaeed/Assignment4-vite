import Pict1 from "../img/bg-showcase-1.jpg";
import Pict2 from "../img/bg-showcase-2.jpg";
import Pict3 from "../img/bg-showcase-3.jpg";

const Section04 = () => {
  return (
    <div className="container">
      <div className="row sec4A" style={{ textAlign: "center" }}>
        ...
        <div className="col-lg-6 col-md-6 col-sm-6 p-0">
          <img src={Pict1} width="100%" height="50%" alt="Picture.jpg" />
        </div>
      </div>

      <div className="row sec4A" style={{ textAlign: "center" }}>
        <div className="col-lg-6 col-md-6 col-sm-6 p-0">
          <img src={Pict2} width="100%" height="50%" alt="Picture.jpg" />
        </div>
      ...
      <div className="row sec4A" style={{ textAlign: "center" }}>
        <div className="col-lg-6 col-md-6 col-sm-4">
          ...
          <p style={{ fontSize: "10px", color: "grey" }}>
            ...
            content and images and <br /> your new landing page will ready to go.
          </p>
        </div>

        <div className="col-lg-6 col-md-6 col-sm-6 p-0">
          <img src={Pict3} width="100%" height="45%" alt="Picture.jpg" />
        </div>
      </div>
    </div>
  );
